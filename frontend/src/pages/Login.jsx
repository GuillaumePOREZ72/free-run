...
import { EnvelopeSimple, Lock, Eye, EyeSlash, Path, GoogleLogo } from '@phosphor-icons/react';
    ...
    <div className="w-full min-h-screen flex items-center justify-center px-4" style={{ background: '#0A0A0A' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-sm" style={{ color: '#A1A1AA' }}>Track your runs. Own your progress.</p>
        </div>

        <div className="p-6 border" style={{ background: '#141414', borderColor: '#27272A', borderRadius: '6px' }}>
          <h2 className="text-2xl mb-6" style={{ fontFamily: 'Bebas Neue', color: '#fff' }}>Sign In</h2>

          {error && (
            <div data-testid="login-error" className="mb-4 p-3 text-sm" style={{ background: 'rgba(255,59,48,0.1)', border: '1px solid rgba(255,59,48,0.3)', color: '#FF3B30', borderRadius: '4px' }}>
              {error}
            </div>
          )}
          ...
          <p className="text-center mt-6 text-sm" style={{ color: '#A1A1AA' }}>
            ...
            <Link to="/register" className="font-semibold no-underline" style={{ color: '#00A3FF' }}>
              Sign Up
            </Link>
          </p>
        </div>
